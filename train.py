...
def validate(val_loader, encoder, decoder, criterion):
    ...
    with torch.no_grad():
        ...
        for i, (imgs, caps, caplens, allcaps) in enumerate(val_loader):
            ...
            # References
            allcaps = allcaps[sort_ind.cpu()]  # 将 sort_ind 移动到 CPU 上
...
def save_checkpoint(data_name, epoch, epochs_since_improvement, encoder, decoder, encoder_optimizer, decoder_optimizer, recent_bleu4, is_best):
    checkpoint_filename = f'checkpoint_{data_name}_epoch_{epoch}.pth.tar'
